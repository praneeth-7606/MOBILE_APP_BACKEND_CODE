...
//     res.status(500).json(formatResponse(false, 'Invalid or expired token'));
//   }
// });
...
//   try {
//     log('info', '🚀 Starting Auth System Server...');
...
//         log('info', `   curl -X POST http://localhost:${CONFIG.PORT}/api/auth/login -H "Content-Type: application/json" -d '{"identifier":"test@example.com","termsAccepted":true}'`);
//         log('info', `   curl -X POST http://localhost:${CONFIG.PORT}/api/auth/login-phone -H "Content-Type: application/json" -d '{"identifier":"+1234567890","termsAccepted":true}'`);
//       }
...
// import cors from 'cors';
// import helmet from 'helmet';
// import { CONFIG, setupDatabase, getPool, closeDatabase } from './config/database.js';
// import { setupCommunication } from './config/email.js';
// import { generalLimiter } from './middleware/ratelimiter.js';
// import { createAuthRoutes } from './routes/authroutes.js';
// import { createUserRoutes } from './routes/userroutes.js';
// import { formatResponse, log } from './utils/helpers.js';
// import { cleanupExpiredSessions } from './utils/otpservice.js';
...
// // Health Check Routes (Render requires this)
// app.get('/health', (req, res) => {
//   res.status(200).json({
//     success: true,
//     message: 'Server is healthy',
...
//     // Setup routes - MUST BE BEFORE 404 handler
...
//       INDEX idx_guest_last_name (guest_last_name),
//       INDEX idx_user_id (user_id),
//       INDEX idx_check_in_date (check_in_date),
//       INDEX idx_booking_status (booking_status),
//       INDEX idx_booking_lookup (booking_id, guest_last_name)
//     )
//   `;
