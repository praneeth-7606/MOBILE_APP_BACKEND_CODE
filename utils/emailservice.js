...
import { sendEmail, sendSMS } from '../config/email.js';

export const sendLoginOTP = async (email, otp, isResend = false) => {
...
export const sendPhoneOTP = async (phone, otp, isResend = false) => {
